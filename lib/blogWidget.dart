...
class _blogWidgetState extends State<blogWidget> {
  ...
  Widget build(BuildContext context) {
    bool mobile = false;
    mobile = MediaQuery.of(context).size.width < 768 ? true : false;

    return Padding(
      padding: const EdgeInsets.only(bottom: 30.0, top: 10),
      child: mobile ?
              Builder(builder: (BuildContext context)=>Column(
                  children: [
                    CarouselSlider(
                      items: [
                        Image.asset(
                    ...
                    Padding(
                      padding:
                          const EdgeInsets.only(right: 50.0, bottom: 20),
                      child: Row(
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                                child: Padding(
                                                  ...
                                                  child: Text("Link to Press Release", style: GoogleFonts.amiri(
                                                      decoration: TextDecoration.underline,
                                                      color: Colors.blue
                                                  ),),
                                                ),
